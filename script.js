...
buttons[0].setAttribute("onclick","del()");
buttons[1].setAttribute("onclick","c()");
buttons[2].setAttribute("onclick","modulus()");
buttons[3].setAttribute("onclick","div()");
...
function mult(){
    ...
    function dot(){
        input.value=input.value+""+buttons[17].innerText;
    }
    function eva(){
